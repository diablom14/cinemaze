...
function Navbar() {
  ...
  return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      gap-8 min-md:px-8 py-3 max-md:h-screen min-md:rounded-full backdrop-blur-xs bg-black/70 
      ...
      <div className=''>
        ...
        {!user ? (<button className='px-4 py-1 sm:px-7 sm:py-2 bg-primary 
        hover:bg-primary-dull transition 
        rounded-full font-medium cursor-pointer' onClick={openSignIn}>
          Login
        </button>) : (
          <UserButton>
      ...
      <MenuIcon className='max-md:ml-4 md:hidden w-8 h-8 
      cursor-pointer'
